...
class BotAI(BotAIInternal):
    ...
    async def on_start(self):
        allies = [UnitTypeId.MEDIVAC, UnitTypeId.MARAUDER, UnitTypeId.MARINE]
        enemies = [UnitTypeId.MEDIVAC, UnitTypeId.MARAUDER, UnitTypeId.MARINE]
        self.start_location = Point2.center([self.units(a).center for a in allies])
        self.enemy_start_locations = [(self.enemy_units(e)|self.enemy_structures(e)).center for e in enemies]
    '''
    ...
    def start_location(self, start_location) -> Point2:
        """
        Returns the spawn location of the bot, using the position of the first created townhall.
        This will be None if the bot is run on an arcade or custom map that does not feature townhalls at game start.
        """
        self.game_info.player_start_location = start_location
    ...
    @enemy_start_locations.setter
    def enemy_start_locations(self, enemy_start_locations):
        """Possible start locations for enemies."""
        self.game_info.start_locations = enemy_start_locations
